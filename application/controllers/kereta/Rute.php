...
class Rute extends Render_Controller {
	...
	public function insert() 
	{
		...
		$harga_dolar 		= $this->input->post('harga_dolar');
		$status 			= $this->input->post('status');

		$r = $this->rute->insert($kode, $kota_asal, $kota_tujuan, $stasiun_asal, $stasiun_tujuan, $harga, $harga_dolar, $status);
	...
	public function update() 
	{
		...
		$r = $this->rute->update($id, $kode, $kota_asal, $kota_tujuan, $stasiun_asal, $stasiun_tujuan, $harga, $harga_dolar, $status);
	...
	function __construct() 
	{
		...
		$this->load->model('kereta/ruteModel', 'rute');
		// cek session
