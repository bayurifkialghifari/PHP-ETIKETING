		...
		<div class="pageheader">
			...
			<div class="page-bar">
				...
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<?=base_url()?>referensi/bandara">Bandara</a>
					</li>
				</ul>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<input type="text" readonly="" id="kode" class="form-control" name="kode" required="required"/>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									<label for="tanggal">Negara</label>
									<div>
										<select id="negara" class="chosen-select" style="width: 100%;" tabindex="3">
											<option value="">Pilih Negara</option>
											<?php foreach($negara as $negara) : ?>
												<option value="<?= $negara['nega_id'] ?>"><?= $negara['nega_nama'] ?></option>
											<?php endforeach; ?>
							          	</select>    
									</div>
								</div>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<div>
										<select id="kota" class="chosen-select" style="width: 100%;" tabindex="3">
											<option value="">Pilih Kota</option>
											<?php foreach($kota as $kota) : ?>
												<option value="<?= $kota['kota_id'] ?>"><?= $kota['kota_nama'] ?> - <?= $kota['kota_kode'] ?></option>
											<?php endforeach; ?>
							          	</select>    
									</div>
								</div>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<textarea class="form-control" id="deskripsi" required="required">
