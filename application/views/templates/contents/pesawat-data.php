				...
				<form role="form" id="form" method="post">
					<div class="modal-body">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									<label for="tanggal">Maskapai</label>
									<div>
										<select id="maskapai" class="chosen-select" style="width: 100%;" tabindex="3">
											<option value="">Pilih Maskapai</option>
											<?php foreach($maskapai as $maskapai) : ?>
												<option value="<?= $maskapai['mask_id'] ?>"><?= $maskapai['mask_nama'] ?></option>
											<?php endforeach; ?>
							          	</select>    
									</div>
								</div>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<textarea id="deskripsi" class="form-control" name="deskripsi" required="required">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									<label for="tanggal">Jumlah Kursi</label>
									<input type="number" id="kursi" class="form-control" name="kursi" required="required">
								</div>
							</div>
						</div>
						<div class="row">
