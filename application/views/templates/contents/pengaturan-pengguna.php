			...
			<div class="modal-content">
				...
				<form role="form" id="form" method="post">
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="password" id="ulangpassword" class="form-control" name="ulangpassword" required="required"/>
								</div>
							</div>
						</div>
						<div class="row">
					...
					<div class="modal-footer">
						<button type="submit" id="simpana" class="btn btn-default btn-border">Simpan</button>
