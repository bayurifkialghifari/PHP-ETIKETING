						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<div>
										<select id="kereta" class="chosen-select" style="width: 100%;" tabindex="3" required="">
									...
									<div>
										<select id="rute" class="chosen-select" style="width: 100%;" tabindex="3" required="">
											...
											<?php foreach($rute as $rute) : ?>
												<option value="<?= $rute['rute_kode'] ?>"><?= $rute['stat_asal'] ?> ( <?= $rute['kota_asal'] ?> )  -  <?= $rute['stat_tujuan'] ?> ( <?= $rute['kota_tujuan'] ?> ) </option>
											<?php endforeach; ?>
							          	</select>    
									</div>
								</div>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<select id="tipe-perjalanan" class="form-control" name="status" required="required">
