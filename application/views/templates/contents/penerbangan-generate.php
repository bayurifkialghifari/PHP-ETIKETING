		...
		<div class="pageheader">
			...
			<div class="page-bar">
				...
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<?=base_url()?>penerbangan/generate">Generate</a>
					</li>
				</ul>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<div>
										<select id="pesawat" class="chosen-select" style="width: 100%;" tabindex="3">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<select id="tipe-penerbangan" class="form-control" name="tipe-penerbangan">
