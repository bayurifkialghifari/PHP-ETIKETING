		...
		<div class="pageheader">
			...
			<div class="page-bar">
				...
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<?=base_url()?>penerbangan/rute">Rute</a>
					</li>
				</ul>
				...
				<form role="form" id="form" method="post">
					<div class="modal-body">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<div>
										<select required="" id="kota_asal" class="chosen-select" style="width: 100%;" tabindex="3">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<div>
										<select required="" id="kota_tujuan" class="chosen-select" style="width: 100%;" tabindex="3">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									<label for="tanggal">Bandara Asal</label>
									<div>
										<select required="" id="bandara_asal" class="chosen-select" style="width: 100%;" tabindex="3">
											<option value="">Pilih Bandara Asal</option>
											<?php foreach($bandara as $ba) : ?>
												<option value="<?= $ba['band_id'] ?>"><?= $ba['band_nama'] ?></option>
											<?php endforeach; ?>
							          	</select>    
									</div>
								</div>
							...
							<div class="col-md-6">
								<div class="form-group">
									<label for="tanggal">Bandara Tujuan</label>
									<div>
										<select required="" id="bandara_tujuan" class="chosen-select" style="width: 100%;" tabindex="3">
											<option value="">Pilih Bandara Tujuan</option>
											<?php foreach($bandara as $bt) : ?>
												<option value="<?= $bt['band_id'] ?>"><?= $bt['band_nama'] ?></option>
											<?php endforeach; ?>
							          	</select>    
									</div>
								</div>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									<label for="tanggal">Harga (USD / 100 KM) </label>
									<input type="text" readonly="readonly" id="harga" class="form-control" name="harga" required="required">
								</div>
							</div>
						</div>
						<div class="row">
