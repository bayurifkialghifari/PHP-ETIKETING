		...
		<div class="pageheader">
			...
			<div class="page-bar">
				...
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<?=base_url()?>pajak/data">Data</a>
					</li>
				</ul>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<input type="text" id="kode" class="form-control" name="kode" required="required"/>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									<label for="tanggal">Persen</label>
									<input type="number" id="persen" class="form-control" name="persen" required="required"/>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<input type="number" id="batas" class="form-control" name="batas" required="required"/>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<input type="number" id="jumlah" class="form-control" name="jumlah" required="required"/>
								</div>
							</div>
						</div>
						<div class="row">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<input type="date" id="tanggal_akhir" class="form-control" name="tanggal_akhir" required="required"/>
								</div>
							</div>
						</div>
					</div>
