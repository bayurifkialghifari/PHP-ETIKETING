<?php defined('BASEPATH') OR exit('No direct script access allowed');
	...
	*/
	$config['facebook_app_id']              = '2691848630875562';
	$config['facebook_app_secret']          = '1298642e97de54fd8715a59988bb5a11';
	$config['facebook_login_type']          = 'web';
	$config['facebook_login_redirect_url']  = 'login/loginWithFB';
