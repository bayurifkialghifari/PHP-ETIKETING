...
class PerjalananModel extends CI_Model {
	...
	{
		$this->db->select('a.*, b.*, c.*, d.*, f.*, g.kota_nama as kota_asal, g.kota_id as kota_asal_id, h.kota_nama as kota_tujuan, h.kota_id as kota_tujuan_id, i.stat_nama as stat_asal, i.stat_id as stat_asal_id, j.stat_nama as stat_tujuan, j.stat_id as stat_tujuan_id, k.*
			');

		$this->db->from('tiket_kereta_detail k');
		$this->db->join('tiket_kereta a', 'k.tikd_tikk_id = a.tikk_id', 'left');
